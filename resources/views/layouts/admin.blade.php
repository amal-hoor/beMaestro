            ...
            <nav class="sidebar-nav bg-dark">
                <ul id="sidebarnav">
                    ...
                    <li class="nav-devider"></li>
                      @php
                         $admins=App\User::where('role_id',1)->get();
                         $admins_number=$admins->count();
                      @endphp
                    <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-account"></i><span class="hide-menu">Admins <span class="label label-rouded label-themecolor pull-right">{{ $admins_number }}</span></span></a>
                    ...
                    <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-account-multiple-outline"></i><span class="hide-menu">Users <span class="label label-rouded label-themecolor pull-right">{{$users_number}}</span></span></a>
                        <ul aria-expanded="false" class="collapse">
                    ...
                    <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-receipt"></i><span class="hide-menu">Payment Methods</span></a>
                        <ul aria-expanded="false" class="collapse">
                            <li><a href="{{ route('paymentmethods.index') }}">All PayMethods</a></li>
                            <li><a href="{{ route('paymentmethods.create') }}">Create Method</a></li>
                        </ul>
                    </li>
